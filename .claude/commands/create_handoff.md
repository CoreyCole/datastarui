...
- create your file under `thoughts/[git_username]/handoffs/ENG-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-ZZZZ_description.md`, where:
  ...
  - IMPORTANT: do no create the file in the `thoughts/shared` directory. it should be created in the `thoughts/[git_username]` directory.
...
```bash
/resume_handoff thoughts/[git_username]/handoffs/PRO-2166/2025-01-08_13-44-55_PRO-2166_create-context-compaction.md
```
...
- **do not create the file in the `thoughts/shared` directory**.
