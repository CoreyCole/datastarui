			...
			for _, section := range sections {
				if section.Title == "Components" {
					for _, item := range section.Items {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/components/componentspage/components_page.templ`, Line: 41, Col: 42}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `pages/components/componentspage/components_page.templ`, Line: 42, Col: 47}
						}
