...
linear get-issue AI-123
# Or if your git branch contains the issue ID (e.g., feature/AI-123-something)
linear get-issue

# Add a comment to an issue (requires message as first parameter)
linear add-comment "This is my comment" --issue-id AI-123  # Explicit ID
...
- Saves them to `thoughts/shared/images/AI-123/`
- Names files as `AI-123-01.png`, `ENG-123-02.jpg`, etc.
...
```
Downloaded 2 images:
thoughts/shared/images/AI-123/ENG-123-01.png
thoughts/shared/images/AI-123/ENG-123-02.jpg
```
...
- Issue ID is either:
  - Auto-detected from git branch name (e.g., `feature/AI-123-something`)
  - Provided with the `--issue-id` or `-i` option (e.g., `-i AI-123`) 
...
```md
## Linear
When asked to fetch a Linear ticket, use the globally installed Linear CLI: `linear get-issue AI-XXXX > thoughts/shared/tickets/eng-XXXX.md`
```
